...
A full-stack inventory management application built with Spring Boot and React that allows users to manage warehouses and items across multiple locations.
...
Track warehouse capacity and location (city, state, country)
...
Track item details: name, SKU, description, quantity, and storage location
...
Items and warehouses have a many-to-many relationship:
...
Transferring items that don’t exist

Transfers to invalid warehouses

Duplicate item-warehouse relationships
